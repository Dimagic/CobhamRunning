...
import net.ddns.dimag.cobhamrunning.view.MyGraph;

public class CalibrationViewController implements Initializable {
	...
	public void initialize(final URL url, final ResourceBundle rb) {
		...
		System.out.println(mathsGraph);
		System.out.println(areaMathsGraph);
	}
